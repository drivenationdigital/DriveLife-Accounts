...
// All icons share these defaults; override via props if needed
...
export const CarIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M14 16H9m10 0h3v-3.15a1 1 0 00-.84-.99L16 11l-2.7-3.6a1 1 0 00-.8-.4H5.24a2 2 0 00-1.8 1.1l-.8 1.63A6 6 0 002 12.42V15.5a.5.5 0 00.5.5H4" />
...
export const ChevLeftIcon = (p: IconProps) => (
  <svg {...base} strokeWidth={2.5} {...p}>
...
export const CircleSlashIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    <circle cx="12" cy="12" r="10" />
...
export const TicketIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M2 9a3 3 0 013-3h14a3 3 0 013 3v2a2 2 0 00-2 2 2 2 0 002 2v2a3 3 0 01-3 3H5a3 3 0 01-3-3v-2a2 2 0 002-2 2 2 0 00-2-2V9z" />
...
export const CarEventsEyeIcon = (p: IconProps) => (
  ...
  >
    ...
    />
    <path
      d="M312.9,19.1c-143.5,0-250.8,119.4-286.8,165.5-8.3,10.6-8.3,25.1,0,35.6,36,46.1,143.3,165.5,286.8,165.5s250.8-119.4,286.8-165.5c8.3-10.6,8.3-25.1,0-35.6-36.1-46.1-143.4-165.5-286.8-165.5Z"
      fill="none"
      stroke="#606060"
      strokeWidth="33.3"
      strokeLinecap="round"
